...
static void update_view(Camera *const camera) {
...
static void update_perspective_projection(PerspectiveCamera *const perspective_camera) {
...
static void Camera_init(Camera *const camera, float x, float y) {
...
inline static void Camera_set_speed(Camera *const camera, const float speed) {
    camera->speed = speed;
}

inline static void Camera_set_position(Camera *const camera, const vec3 position) {
    memcpy(camera->position, position, sizeof(vec3));
    update_view(camera);
}

inline static void Camera_set_front(Camera *const camera, const vec3 front) {
    memcpy(camera->front, front, sizeof(vec3));
    update_view(camera);
}

static void Camera_set_angles(Camera *const camera, const float yaw, const float pitch) {
    camera->yaw = yaw;
    if(pitch > 89.0f) {
        camera->pitch = 89.0f;
    } else if(pitch < -89.0f) {
...
static void Camera_change_direction(Camera *const camera, const float x, const float y) {
...
static void Camera_move_straight_up(Camera *const camera) {
    vec3 translate;
...
static void Camera_move_straight_down(Camera *const camera) {
    vec3 translate;
    glm_vec3_scale(UP, camera->speed, translate);
...
static void Camera_move_straight_front(Camera *const camera) {
    vec3 translate;
...
static void Camera_move_straight_back(Camera *const camera) {
    vec3 translate;
    glm_vec3_scale(camera->front, camera->speed, translate);
    glm_vec3_sub(camera->position, translate, camera->position);
    camera->position[Y] = 0.0f;
...
static void Camera_move_straight_right(Camera *const camera) {
    vec3 translate;
...
static void Camera_move_straight_left(Camera *const camera) {
    vec3 translate;
    glm_cross(camera->front, UP, translate);
    glm_normalize(translate);
    glm_vec3_scale(translate, camera->speed, translate);
...
static void Camera_move_front(Camera *const camera) {
    vec3 translate;
    glm_vec3_scale(camera->front, camera->speed, translate);
    glm_vec3_add(camera->position, translate, camera->position);
    update_view(camera);
...
static void Camera_move_back(Camera *const camera) {
    vec3 translate;
    glm_vec3_scale(camera->front, camera->speed, translate);
    glm_vec3_sub(camera->position, translate, camera->position);
    update_view(camera);
...
static void Camera_move_right(Camera *const camera) {
    vec3 translate;
    glm_cross(camera->front, UP, translate);
    glm_normalize(translate);
    glm_vec3_scale(translate, camera->speed, translate);
...
static void Camera_move_left(Camera *const camera) {
    vec3 translate;
    glm_cross(camera->front, UP, translate);
    glm_normalize(translate);
    glm_vec3_scale(translate, camera->speed, translate);
...
inline static float *Camera_get_view(const Camera *const camera) {
    return (float*)camera->view;
}

inline static float *Camera_get_projection(const Camera *const camera) {
    return (float*)camera->projection;
}

inline void PerspectiveCamera_init(PerspectiveCamera *const perspective_camera, const float x, const float y) {
...
inline void PerspectiveCamera_set_speed(PerspectiveCamera *const perspective_camera, const float speed) {
    Camera_set_speed(&perspective_camera->camera, speed);
}

inline void PerspectiveCamera_set_position(PerspectiveCamera *const perspective_camera, const vec3 position) {
    Camera_set_position(&perspective_camera->camera, position);
}

inline void PerspectiveCamera_set_looking_at(PerspectiveCamera *const perspective_camera, const vec3 looking_at) {
    Camera_set_front(&perspective_camera->camera, looking_at);
}

inline void PerspectiveCamera_set_angles(PerspectiveCamera *const perspective_camera, const float yaw, const float pitch) {
    Camera_set_angles(&perspective_camera->camera, yaw, pitch);
}

inline void PerspectiveCamera_change_direction(PerspectiveCamera *const perspective_camera, const float x, const float y) {
    Camera_change_direction(&perspective_camera->camera, x, y);
}

inline void PerspectiveCamera_move_straight_up(PerspectiveCamera *const perspective_camera) {
    Camera_move_straight_up(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_straight_down(PerspectiveCamera *const perspective_camera) {
    Camera_move_straight_down(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_straight_front(PerspectiveCamera *const perspective_camera) {
    Camera_move_straight_front(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_straight_back(PerspectiveCamera *const perspective_camera) {
    Camera_move_straight_back(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_straight_right(PerspectiveCamera *const perspective_camera) {
    Camera_move_straight_right(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_straight_left(PerspectiveCamera *const perspective_camera) {
    Camera_move_straight_left(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_front(PerspectiveCamera *const perspective_camera) {
    Camera_move_front(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_back(PerspectiveCamera *const perspective_camera) {
    Camera_move_back(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_right(PerspectiveCamera *const perspective_camera) {
    Camera_move_right(&perspective_camera->camera);
}

inline void PerspectiveCamera_move_left(PerspectiveCamera *const perspective_camera) {
    Camera_move_left(&perspective_camera->camera);
}

inline float *PerspectiveCamera_get_view(const PerspectiveCamera *const perspective_camera) {
    return Camera_get_view(&perspective_camera->camera);
}

inline float *PerspectiveCamera_get_projection(const PerspectiveCamera *const perspective_camera) {
