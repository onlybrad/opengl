...
void Shader_set_bool_l(Shader *const shader, const int location, bool value);
void Shader_set_int_l(Shader *const shader, const int location, int value);
void Shader_set_float_l(Shader *const shader, const int location, float value);
